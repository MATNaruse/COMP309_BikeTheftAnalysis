...
#     @staticmethod
#     def get_trimmed_dataset(dropColumns:[] = None) -> pandas.DataFrame:
#         """
...
#         """
#         if not dropColumns:
#             return BikeData.get_raw_dataset().drop(columns=BikeData.DropColumns)
#         else:
#             return BikeData.get_raw_dataset().drop(columns=dropColumns)
